...
/**
 * @author HuSen
 * create on 2020/1/13 14:33
 */
@Setter
@Getter
@ToString
public class AddSmsSignRequest extends BaseSmsRequest<AddSmsSignResponse> {
    private static final long serialVersionUID = 9106912661736026312L;
    ...
    public AddSmsSignRequest(SMSAlice smsAlice, String signName, SignSource signSource, String remark, String fileSuffix, String fileContents) {
        super(smsAlice);
    ...
    @Override
    protected Class<AddSmsSignResponse> responseClazz() {

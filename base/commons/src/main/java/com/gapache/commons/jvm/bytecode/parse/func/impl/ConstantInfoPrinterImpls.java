...
public final class ConstantInfoPrinterImpls {
    public static final ConstantInfoPrinter VALUE_CONSTANT_INFO_PRINTER = (pool, index, item) -> {
    ...
    public static final ConstantInfoPrinter CLASS_AND_STRING_CONSTANT_INFO_PRINTER = (pool, index, item) -> {
    ...
    public static final ConstantInfoPrinter FIELD_AND_METHOD_REF_CONSTANT_INFO_PRINTER = (pool, index, item) -> {
        IndexConstantItem indexItem = (IndexConstantItem) item;
    ...
    public static final ConstantInfoPrinter NAME_AND_TYPE_CONSTANT_INFO_PRINTER = (pool, index, item) -> {
        IndexConstantItem indexItem = (IndexConstantItem) item;

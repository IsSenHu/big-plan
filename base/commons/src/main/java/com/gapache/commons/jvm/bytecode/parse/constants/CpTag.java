...
public enum CpTag {
    ...
    CONSTANT_METHOD_HANDLE_INFO(15, 3, "MethodHandle", METHOD_HANDLE_CONSTANT_INFO_PARSER, null),
    CONSTANT_METHOD_TYPE_INFO(16, 2, "MethodType", INDEX_CONSTANT_INFO_PARSER, null),
    CONSTANT_INVOKE_DYNAMIC_INFO(18, 4, "InvokeDynamic", INDEX_CONSTANT_INFO_PARSER, null),
